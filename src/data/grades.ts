...
export const gradesData: SubjectGrades[] = [
  {
    ...
    terms: [
      { term: "Първи срок", current: [5, 4, 2, 2, 2, 3].map(g), termGrade: 3 },
      { term: "Втори срок", current: [6].map(g), termGrade: 0 },
    ],
  },
  {
    subject: "Немски език",
    terms: [
      { term: "Първи срок", current: [6, 4, 6].map(g), termGrade: 5 },
      { term: "Втори срок", current: [6].map(g), termGrade: 0 },
    ],
  },
  {
    subject: "Математика",
    terms: [
      { term: "Първи срок", current: [3, 2, 3, 3].map(g), termGrade: 3 },
      { term: "Втори срок", current: [5].map(g), termGrade: 0 },
    ],
  },
  {
    subject: "Гражданско образование",
    terms: [
      { term: "Първи срок", current: [5, 5].map(g), termGrade: 5 },
    ],
  },
  {
    subject: "Физическо възпитание и спорт",
    terms: [
      { term: "Първи срок", current: [6, 6, 6, 6].map(g), termGrade: 6 },
    ],
  },
  {
    subject: "Чужд език по професията (ОбПП)",
    terms: [
      { term: "Първи срок", current: [4, 5, 4].map(g), termGrade: 4 },
      { term: "Втори срок", current: [5, 6].map(g), termGrade: 0 },
    ],
  },
  {
    subject: "Бази данни - практика (ИУЧ - ОтПП)",
    terms: [
      { term: "Първи срок", current: [6, 6, 6].map(g), termGrade: 6 },
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [6, 6, 6].map(g), termGrade: 6 },
      { term: "Втори срок", current: [6, 6].map(g), termGrade: 0 },
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [5, 3].map(g), termGrade: 4 },
      { term: "Втори срок", current: [6].map(g), termGrade: 0 },
    ],
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [6, 6].map(g), termGrade: 6 },
      { term: "Втори срок", current: [5].map(g), termGrade: 0 },
    ],
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [5, 6, 6].map(g), termGrade: 6 },
    ],
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [6, 6, 6].map(g), termGrade: 6 },
      { term: "Втори срок", current: [6, 5].map(g), termGrade: 0 },
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [5, 6].map(g), termGrade: 6 },
    ],
  },
  {
    subject: "Математически основи на програмирането - теория (ИУЧ - СПП)",
    terms: [
      { term: "Първи срок", current: [3, 4].map(g), termGrade: 4 },
      { term: "Втори срок", current: [4].map(g), termGrade: 0 },
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      { term: "Първи срок", current: [4, 6, 6].map(g), termGrade: 6 },
      { term: "Втори срок", current: [5].map(g), termGrade: 0 },
    ],
  },
  {
  ...
  { subject: "Спортни дейности (футбол) (...)", terms: [] },
  { subject: "Безопасност на движението (...)", terms: [] },
  { subject: "Час на класа (...)", terms: [] },
  { subject: "Гражданско образование (...)", terms: [] },
];